...
It does not contain `.venv`, local caches, runtime settings, or locally downloaded
Hugging Face metadata. After extraction on the target PC, recreate the development environment:
